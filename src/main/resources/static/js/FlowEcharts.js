...
FlowEcharts.prototype._createChartOverlay = function() {
  ...
  var echartDom = document.getElementById('forE')
  echartDom.style.position = 'relative'
  echartDom.style.bottom = scene.canvas.height + 'px'
  // echartDom.style.zIndex = '10'
  // echartDom.style.bottom = '100px'
